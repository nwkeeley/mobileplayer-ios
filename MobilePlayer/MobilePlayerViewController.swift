...
open class MobilePlayerViewController: MPMoviePlayerViewController {
    ...
    public func showContentActions(sourceView: UIView? = nil) {
        ...
        moviePlayer.pause()
        let activityVC = UIActivityViewController(activityItems: activityItems, applicationActivities: [SaveVideoActivity()])
        ...
        activityVC.completionWithItemsHandler = { activityType, completed, returnedItems, activityError in
            ...
            if(activityType == SaveVideoActivity().activityType){
